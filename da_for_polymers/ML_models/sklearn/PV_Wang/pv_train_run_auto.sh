...
do
    ...
    # FINGERPRINT
    python ../train.py --train_path ../../../data/input_representation/PV_Wang/fingerprint/StratifiedKFold/input_train_[0-9].csv --test_path ../../../data/input_representation/PV_Wang/fingerprint/StratifiedKFold/input_test_[0-9].csv --feature_names PS_FP_radius_3_nbits_512,Contact_angle,Thickness_um,Solvent_solubility_parameter_Mpa_sqrt,xw_wt_percent,Temp_C,Permeate_pressure_mbar --target_name J_Total_flux_kg_m_2h_1 --model_type "$model" --hyperparameter_optimization False --hyperparameter_space_path ./pv_hpo_space.json --results_path ../../../training/PV_Wang/fingerprint --random_state 22
    ...
    # MANUAL FRAG STR
    # python ../train.py --train_path ../../../data/input_representation/PV_Wang/manual_frag/StratifiedKFold/input_train_[0-9].csv --test_path ../../../data/input_representation/PV_Wang/manual_frag/StratifiedKFold/input_test_[0-9].csv --feature_names PS_manual_SMILES,Contact_angle,Thickness_um,Solvent_solubility_parameter_Mpa_sqrt,xw_wt_percent,Temp_C,Permeate_pressure_mbar --target_name J_Total_flux_kg_m_2h_1 --model_type "$model" --hyperparameter_optimization True --hyperparameter_space_path ./pv_hpo_space.json --results_path ../../../training/PV_Wang/manual_frag_SMILES --random_state 22
    
    # AUGMENTED MANUAL FRAG STR
    # python ../train.py --train_path ../../../data/input_representation/PV_Wang/manual_frag/StratifiedKFold/input_train_[0-9].csv --test_path ../../../data/input_representation/PV_Wang/manual_frag/StratifiedKFold/input_test_[0-9].csv --feature_names PS_manual_aug_SMILES,Contact_angle,Thickness_um,Solvent_solubility_parameter_Mpa_sqrt,xw_wt_percent,Temp_C,Permeate_pressure_mbar --target_name J_Total_flux_kg_m_2h_1 --model_type "$model" --hyperparameter_optimization True --hyperparameter_space_path ./pv_hpo_space.json --results_path ../../../training/PV_Wang/manual_frag_aug_SMILES --random_state 22
    ...
    # python ../train.py --train_path ../../../data/input_representation/PV_Wang/manual_frag/StratifiedKFold/input_train_[0-9].csv --test_path ../../../data/input_representation/PV_Wang/manual_frag/StratifiedKFold/input_test_[0-9].csv --feature_names PS_manual_recombined_aug_FP,Contact_angle,Thickness_um,Solvent_solubility_parameter_Mpa_sqrt,xw_wt_percent,Temp_C,Permeate_pressure_mbar --target_name J_Total_flux_kg_m_2h_1 --model_type "$model" --hyperparameter_optimization True --hyperparameter_space_path ./pv_hpo_space.json --results_path ../../../training/PV_Wang/manual_recombined_aug_fingerprint --random_state 22
