...
do
    # AUGMENTED SMILES
    # python ../train.py --train_path ../../../data/input_representation/DFT_Ramprasad/augmented_SMILES/KFold/input_train_[0-9].csv --test_path ../../../data/input_representation/DFT_Ramprasad/augmented_SMILES/KFold/input_test_[0-9].csv --feature_names Augmented_SMILES --target_name value --model_type "$model" --hyperparameter_optimization True --hyperparameter_space_path ./dft_hpo_space.json --results_path ../../../training/DFT_Ramprasad/Augmented_SMILES --random_state 22
