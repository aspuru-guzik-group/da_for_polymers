...
CFP_CO2_DATA = pkg_resources.resource_filename(
    "da_for_polymers",
    "data/input_representation/CO2_Soleimani/circular_fingerprint/co2_circular_fingerprint.csv",
)
...
if __name__ == "__main__":
    Nmer_graph(MASTER_CO2_DATA, CFP_CO2_DATA, 2)
    Nmer_graph(CFP_CO2_DATA, CFP_CO2_DATA, 3)
    polymer_graph(CFP_CO2_DATA, CFP_CO2_DATA, 3)
