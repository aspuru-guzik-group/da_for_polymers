...
# python ./cross_validation.py --dataset_path ~/Research/Repos/da_for_polymers/da_for_polymers/data/input_representation/DFT_Ramprasad/BRICS/master_brics_frag.csv --num_of_folds 5 --type_of_crossval KFold
