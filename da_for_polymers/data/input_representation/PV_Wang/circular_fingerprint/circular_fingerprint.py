...
PV_DATA = pkg_resources.resource_filename(
    "da_for_polymers",
    "data/preprocess/PV_Wang/pv_exptresults.csv",
)

PV_CFP_DATA = pkg_resources.resource_filename(
    "da_for_polymers",
    "data/input_representation/PV_Wang/circular_fingerprint/pv_circular_fingerprint.csv",
)
...
if __name__ == "__main__":
    Nmer_graph(PV_DATA, PV_CFP_DATA, 2)
    Nmer_graph(PV_CFP_DATA, PV_CFP_DATA, 3)
    polymer_graph(PV_CFP_DATA, PV_CFP_DATA, 3)
